 ...
 * @param deleteFlag    delete flag of the reminder
 * @param requestCode   request code of the reminder
 */
...
data class ReminderDTO(
    ...
    @ColumnInfo(name = "delete_flag") var deleteFlag: Int? = 0,
    @ColumnInfo(name = "request_code") var requestCode: Int?
)
